...
local delivery_drone = {
	...
	animation = {
		layers = {
			...
			},
			{
				...
				stripes = {
					{
						filename = base_path .. "/graphics/entity/drone-msk-a.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = base_path .. "/graphics/entity/drone-msk-b.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = base_path .. "/graphics/entity/drone-msk-c.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = base_path .. "/graphics/entity/drone-msk-d.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
				},
	...
	working_sound = {
		sound = {
			filename = base_path .. "/sounds/engine.ogg",
			volume = 0.4,
		},
		poop_activate_sound = {
	...
	minimap_representation = {
		filename = base_path .. "/graphics/long-range-delivery-drone-map.png",
		flags = { "icon" },
		size = { 128, 128 },
		scale = 0.5,
	},
...
local delivery_drone_item = {
	type = "item",
	name = "long-range-delivery-drone",
	localised_name = { "entity-name.long-range-delivery-drone" },
	localised_description = { "entity-description.long-range-delivery-drone" },
